...
for name in dataname:
    ...
    for folder in folders:
        ...
        config = Config({
            ...
            'txt_file_name': f'data_json/for_leave_one_out/{name}/{folder}/',                # list of images in the database
            ...
            'n_epoch': 50,                         # total training epochs
        ...
        train_dataset = JSONData(
            ...
            txt_file_name=config.txt_file_name + 'train.json',
        ...
        test_dataset = JSONData(
            db_path=config.db_path,
            txt_file_name=config.txt_file_name + 'test.json',
            scale_1=config.scale_1,
            scale_2=config.scale_2,
        ...
        for epoch in range(start_epoch, config.n_epoch):
            ...
            print(f'Best SROCC: {best_srcc}')
            print(f'Best PLCC: {best_plcc}')
